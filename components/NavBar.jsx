...
// TailwindCSS styles
const navBtnStyles =
  "block mt-4 lg:inline-block lg:mt-0 text-regalBlue-800 border-b-transparent border-b-4 pb-2 hover:border-b-regalBlue-800";
        ...
        <div className="flex flex-row">
          <>
            {user ? (
              <Link
                href="/profile"
                className="text-lg px-4 py-2 border-2 rounded-md text-rawSienna-500 border-rawSienna-500 hover:border-transparent hover:bg-rawSienna-500 hover:text-white mt-4 mr-2 lg:mt-0"
              >
                Profile
              </Link>
            ) : (
          ...
          <Link
            href="/dashboard"
            className="text-lg px-4 py-2 border-2 rounded-md text-rawSienna-500 border-rawSienna-500 hover:border-transparent hover:bg-rawSienna-500 hover:text-white mt-4 lg:mt-0"
          >
            Dashboard
          </Link>
        </div>
