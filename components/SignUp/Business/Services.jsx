  ...
  return (
    <div className="w-[800px] min-h-min min-w-min bg-stone-50 p-6 rounded-3xl shadow-lg flex flex-col justify-evenly ">
        <div className="flex justify-between items-center mt-4">
            <div className="px-4">
                <div className=" cursor-pointer h-4 w-4 hover:scale-125 transition" onClick={() => setScreen("PG_BUSINESS_BASICINFO")}>
            ...
            <div className="text-center font-bold">
                <h1 className=" text-4xl text-neutral-800 font-bold">What services interest you?</h1>
            </div>
            <div className="px-4">
                <div className=" cursor-pointer h-4 w-4 hover:scale-125 transition" onClick={() => setScreen("PG_BUSINESS_CREATEACCOUNT")}>
