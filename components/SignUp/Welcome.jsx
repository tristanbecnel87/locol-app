  ...
  return (
    <div className="w-[800px] min-h-min min-w-min bg-stone-50 p-6 rounded-3xl shadow-lg flex flex-col justify-evenly ">
        ...
        <div className="px-32 pt-4">
            ...
            <div class=" my-4 py-2 px-4 block w-full border border-stone-300 rounded-full text-sm shadow-lg cursor-pointer" onClick={setStudent}>
                <h2 className="text-neutral-800 text-lg font-medium pl-5">Student</h2>
            </div>
            <div class=" my-4 py-2 px-4 block w-full border border-stone-300 rounded-full text-sm shadow-lg cursor-pointer" onClick={setBusiness}>
                <h2 className="text-neutral-800k text-lg font-medium pl-5">Business</h2>
            </div>
        </div>
        <p className="pt-4 text-gray-400 text-center pb-5">
            Already have an account? <Link className=" text-rawSienna-500"  href="/signUp">Sign in</Link> instead.
        </p>
    </div>
  );
};
