        ...
        <div className="flex flex-col items-center justify-center text-white tracking-wider font-light">
          <div className="m-4 hover:opacity-50 cursor-pointer relative">
            <Image
              ...
              src={imageUrl ? imageUrl : "/defaultProfilePic.svg"}
              alt="profilePhoto"
              width={150}
              height={150}
            />
      ...
      <div className="py-6">
        <div>
          ...
          >
            <button
              type="button"
              className="hs-tab-active:font-semibold hs-tab-active:border-rawSienna-500 hs-tab-active:text-rawSienna-500 tracking-wider py-3 px-4 mx-4 inline-flex items-center gap-2 border-b-[3px] border-transparent whitespace-nowrap text-gray-500 hover:text-rawSienna-600 active"
            ...
            <button
              type="button"
              className="hs-tab-active:font-semibold hs-tab-active:border-rawSienna-500 hs-tab-active:text-rawSienna-500 tracking-wider py-3 px-4 mx-4 inline-flex items-center gap-2 border-b-[3px] border-transparent whitespace-nowrap text-gray-500 hover:text-rawSienna-600"
        ...
        <div className="tracking-wide text-md max-w-lg m-auto p-6 h-36">
          ...
          >
            <p className="text-gray-500 dark:text-gray-400 text-center">
              {description
                ? description
                : "Add your bio here!! You can edit this by clicking the edit button in the top right corner."}
            </p>
          </div>
          <div
          ...
          >
            <p className="text-gray-500 dark:text-gray-400 text-center">
              {services
                ? services
                : "You currently don't have any services listed. Create a service by heading over to the marketplace tab and clicking the 'Create Service' button!"}
            </p>
          </div>
          <div
          ...
          >
            <p className="text-gray-500 dark:text-gray-400 text-center">
              {interests
                ? interests
                : "You currently don't have any interests listed. Add an interest by clicking the edit button in the top right corner."}
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-lg m-auto tracking-wide">
          {skills ? (
            ...
            <p className="text-gray-500 dark:text-gray-400 text-center pb-4">
              You currently don't have any skills listed. Add a skills by
              clicking edit profile in the top right corner.
            </p>
          )}
        </div>
      </div>
